...
原文链接：https://blog.csdn.net/weixin_39025679/article/details/115479014
        content = self.ui.textEdit.toPlainText()
        html = markdown(content, extensions=[FencedCodeExtension(), CodeHiliteExtension(linenums=False)])
